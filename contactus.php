	...
	<div class="contactus"  style="background-color:#fff;">
		...
		<div class="main_content">
			<div class="col-md-6" style="border-right: 2px solid black;">
				<article>
					<h2>ASIIMWE IVAN <h2><h4>Studied B.Sc in Software Engineering</h4>
							<h5>Cavendish University Uganda.</h5>
						<p> asiimwe@twetter <br> 
						       Asiimwe7610@gmail.com<br>
							https://linkedin.com/Asiimwe <br>
							https://facebook/Asiimwe Ivan Brian <br>
							cell: +256752356013</p><br>
				</article>
			</div>
			<div class="col-md-6">
